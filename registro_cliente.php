...
<head>
  <meta charset="UTF-8">
  <title>Registro Cliente - Cloud Food</title>
...
<body>
  ...
  <div class="register-box">
    ...
    <form id="registerForm">
      ...
      <button type="submit" class="btn"><i class="fa-solid fa-paper-plane"></i> Crear Cuenta</button>
    </form>
    <div class="links">
      <a href="login_trabajador.php"><i class="fa-solid fa-right-to-bracket"></i> Iniciar Sesión</a>
      <a href="login_cliente.php"><i class="fa-solid fa-arrow-left"></i> Volver</a>
    </div>
  </div>
  ...
  <script>
    document.getElementById("registerForm").addEventListener("submit", async function(e) {
      ...
      const response = await fetch("procesar_registro_trabajador.php", { method: "POST", body: formData });
      ...
      if (result.success) {
        ...
        setTimeout(() => { window.location.href = "login_trabajador.php"; }, 2000);
      } else {
        Swal.fire({
          title: "⚠️ Error",
          text: result.message,
